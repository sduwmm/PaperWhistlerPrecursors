...
% %%%%弃之不用TintInterested=irf.tint('2017-12-17T17:53:19.500Z/2017-12-17T17:53:21.000Z');
...
% TintInterested=irf.tint('2017-12-29T19:11:36.000Z/2017-12-29T19:11:37.000Z');%%%>0.8
% TintInterested=irf.tint('2017-12-29T19:11:39.000Z/2017-12-29T19:11:41.000Z');%%%<0.8
...
% %%%%%%%%%%%('2018-12-10T06:28:57.000Z/2018-12-10T06:28:58.300Z');
% %%%%%%%%%%%('2018-12-10T06:28:58.000Z/2018-12-10T06:28:59.000Z');
...
%%
ic=1;
c_eval('BxyzSRVY=mms.db_get_ts(''mms?_fgm_srvy_l2'',''mms?_fgm_b_gse_srvy_l2'',Tint);',ic);
...
inteTime=find(epochBsrvy >= TintInterested.epoch(1) & epochBsrvy <= TintInterested.epoch(2));
arrInteBxyz=arrBxyz(inteTime,:);
BxyzBO=mean(arrInteBxyz,1)
%cosThetaKB=(normal(1)*BxyzBO(1)+normal(2)*BxyzBO(2)+normal(3)*BxyzBO(3))/(sqrt(normal(1)*normal(1)+normal(2)*normal(2)+normal(3)*normal(3))*sqrt(BxyzBO(1)*BxyzBO(1)+BxyzBO(2)*BxyzBO(2)+BxyzBO(3)*BxyzBO(3)));
%thetaKB=acos(abs(cosThetaKB))/pi*180
