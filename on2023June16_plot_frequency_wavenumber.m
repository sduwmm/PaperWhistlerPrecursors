...
% scatter(4.416,1.179,'MarkerEdgeColor',[1 0 0],'MarkerFaceColor',[1 0 0], 'LineWidth',LineWidth);
% scatter(11.8,1.439,'MarkerEdgeColor',[1 0 0],'MarkerFaceColor',[1 0 0], 'LineWidth',LineWidth);
% text(4.36,1.33,'1','color','r')
